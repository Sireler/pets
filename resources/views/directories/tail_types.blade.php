...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Справочник: ТИПЫ ХВОСТОВ</div>
                            ...
                            @foreach($types as $type)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{{ route('directories.tail_types.delete', $type->id) }}">
                                            @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Типы хвостов</h5>
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('directories.tail_types.update') }}">
                        @method('PUT')
                        @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('directories.tail_types.store') }}">
                        @csrf
                        <div class="form-group">
                            <label for="org-name">Наименование</label>
